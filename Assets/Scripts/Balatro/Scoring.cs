...
{
    readonly List<PossiblePokerHand> possiblePokerHands = new();

    public Scoring()
    {
        InitiatePossiblePokerHands();
    }
    ...
    public int Score(List<PokerCard> playedHand)
    {
        ...
        ScoreData.handName = scoredHand.name;
    ...
    {
        List<PokerCard> scoredCards = new();
    ...
    public void InitiatePossiblePokerHands() 
    {
